...
class FeatureJobsScreen extends StatefulWidget {
  const FeatureJobsScreen({Key? key}) : super(key: key);

  @override
  State<FeatureJobsScreen> createState() => _FeatureJobsScreenState();
}

class _FeatureJobsScreenState extends State<FeatureJobsScreen> {
  @override
